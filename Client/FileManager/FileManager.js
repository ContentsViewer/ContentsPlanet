    ...
    static Open(){
        ...
        request.onload = function (e) {
            ...
            for(var i = 0; i < fileList.length; i++){
                var file = this.fileElement.fileManager.CreateFileElement(false, fileList[i], true);
        ...
        request.onload = function (e) {
            ...
            for(var i = 0; i < folderList.length; i++){
                var folder = this.fileElement.fileManager.CreateFileElement(true, folderList[i], true);
