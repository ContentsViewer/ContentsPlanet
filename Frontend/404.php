...
$vars['panelContentOnIdle'] = 
    ...
    "<a style='flex-basis: 30%;' href='" . CreateContentHREF($vars['rootContentPath']) . "'>TopPage<br>から探す</a>" .
    "<a style='flex-basis: 30%;' href='" . ROOT_URI . dirname($vars['subURI']) . "'>同ディレクトリから探す</a></div>" .
...
$vars['panelContentOnGameover'] = 
    ...
    "<a style='flex-basis: 30%;' href='javascript:void(0);' onclick='OnClickSearchButton(&#39;" . H($vars['subURI']) . "&#39;)'>検索する</a>" .
    "<a style='flex-basis: 30%;' href='" . CreateContentHREF($vars['rootContentPath']) . "'>TopPageから探す</a>" .
    "<a style='flex-basis: 30%;' href='" . ROOT_URI . dirname($vars['subURI']) . "'>同ディレクトリから探す</a></div> or";
