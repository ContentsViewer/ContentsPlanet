...
<body>
  ...
  <div id='right-column'>
    ...
    <nav class='navi'>
      <div style='margin-left: 1em'><?= Localization\Localize('noOutline', 'There is no Outline.') ?></div>
    </nav>
    ...
    <main id="main">
      <article>
        ...
        <div id="doc-outline-embeded" class="accbox">
          ...
          <label for="toggle-doc-outline" role="button" title="<?= Localization\Localize('expandCollapseContents', 'Expand/collapse contents') ?>">
            <div class="icon"></div>
          </label>
        </div>
